...
如果你需要维护或新增本项目中的 AI 接口逻辑，**请务必仔细阅读** [《AI 接口开发规范与防坑指南》](./AI_DEVELOPMENT_RULES.md)。
该文档规范了多平台 API 密钥隔离、严格的请求 Header 格式等，以防范在图片（TT API）和视频（Tuzi API）服务之间跨供应商混用 API Key 所导致的线上故障。
